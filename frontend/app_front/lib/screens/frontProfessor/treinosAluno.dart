...
class _TreinosAlunoState extends State<TreinosAluno> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            _buildListaTreinos("Treino de aquecimento", "03/05/2021", "03/06/2021", "ATIVO", Colors.green),
            _buildListaTreinos("Treino de introdução", "03/04/2021", "03/05/2021", "INATIVO", Colors.red),
            _buildListaTreinos("Treino teste", "25/03/2021", "01/04/2021", "INATIVO", Colors.red),
          ],
        ),
      ),
    );
  ...
  Widget _buildListaTreinos(String nomeTreino, String dataInicio, String dataFim, String status, Color color) => Padding(
