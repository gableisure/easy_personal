import "dart:async";
import 'dart:convert';
import 'package:app_front/models/teacherSingUp.dart';
import 'package:http/http.dart' as http;

class APISingUpTeacher {
  Future<TeacherSingUp> singUp(String vhr_email, String vhr_senha, String passwordConfirm, String vhr_nome, String vhr_sobrenome, String dtt_nascimento,
    ...
    if(response.statusCode == 200 || response.statusCode == 201) {
      ...
      print("${response.body}");
      return TeacherSingUp.fromJson(json.decode(response.body));
